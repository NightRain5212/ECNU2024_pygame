...
# 魔法箭COST
MAGIC_ARROW_COST_MP = 25
# 魔法箭攻击力(倍率)
MAGIC_ARROW_ATK_RATE = 0.05
# 魔法箭攻击范围
MAGIC_ARROW_ATK_RANGE = 400
# 魔法箭速度
...
FIREGIANT_MAXHP = 800
FIREGIANT_ATK = 25
FIREGIANT_STRACT_CD = 10000
FIREGIANT_FIREOPEN_CD = 5000
FIREGIANT_ATTACKRANGE = 300
FIREGIANT_DETECTRANGE = 600
FIREGIANT_SPEED = 2
